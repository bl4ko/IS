...
#
#install.packages("GA",
#lib="/mylibs/Rpackages/")
      ## or some other path, e.g., C:\yourFolder
...
# plot the solution
curve(f, from = -3, to = 3, n = 1000)
points(GA@solution, f(GA@solution), col="blue")
...
values <- c(5, 8, 3, 4, 6, 5, 4, 3, 2) # a vector of the items' values
weights <- c(1, 3, 2, 4, 2, 1, 3, 4, 5) # a vector of the item's weights
Capacity <- 10 # the knapsack capacity
